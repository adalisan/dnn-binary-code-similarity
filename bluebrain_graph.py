...
def main():
    ...
    graph_Bmu = np.loadtxt(
        "/nfs/raid89/u21/projects/GraphMatchApps/Bluebrain/reports/graphBmu.Rmat",usecols=range(1,55),skiprows=1)
    block_sizes = np.loadtxt(
        "/nfs/raid89/u21/projects/GraphMatchApps/Bluebrain/reports/rho.Rmat",usecols=[1],skiprows=1)
